...
<body>
    ...
    <section class="py-5" style="margin-top: 100px">
        <div class="container col-xxl-8 py-5">
            ...
            <form action="{{route('magang.update', $artikel->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-grup mb-4">
                    <label for="">Masukan Judul Kegiatan</label>
                    <input type="text" name="judul" required class="form-control @error('judul') is invalid @enderror"value="{{old('judul', $artikel->judul)}}">
                ...
                <div class="form-grup mb-4">
                    <label for="">Masukan Nama Perusahaan</label>
                    <input type="text" name="nama_perusahaan" required class="form-control @error('nama_perusahaan') is invalid @enderror"value="{{old('nama_perusahaan', $artikel->nama_perusahaan)}}">
                ...
                <div class="form-grup mb-4">
                    ...
                    <textarea name="desc" required id="summernote">{!! $artikel->desc !!}</textarea>
                ...
                <div class="form-group mb-4">
                    <label for="">Masukan File</label>
                    <input type="hidden" name="old_formulir" value="{{ $artikel->formulir }}">
                    <input type="file" name="formulir" accept="pdf" class="form-control @error('formulir') is-invalid @enderror" value="{{ old('formulir') }}">
