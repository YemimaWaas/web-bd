    ...
    <section class="py-5" style="margin-top: 100px">
        <div class="container col-xxl-8 py-5">
            ...
            <div class="d-flex">
                ...
                <div class="mx-1"> . </div>
                <a href="">Buat Info Magang</a>
            </div>

            <h4>Halaman Buat Info Magang</h4>
            ...
            <form action="{{route('magang.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grup mb-4">
                    ...
                    <input type="text" name="nama_perusahaan" required class="form-control @error('nama_perusahaan') is invalid @enderror"value="{{old('nama_perusahaan')}}">
                ...
                <div class="form-grup mb-4">
                    ...
                    <input type="file" name="image" accept="jpeg,png,jpg,webp" required class="form-control @error('image') is-invalid @enderror" name="image" value="{{old('image')}}">
                ...
                <div class="form-grup mb-4">
                    ...
                    <textarea name="desc" required id="summernote">{{ old('desc') }}</textarea>
                ...
                <div class="form-grup mb-4">
                    ...
                    <input type="file" name="formulir" accept="pdf,docx" required class="form-control @error('formulir') is invalid @enderror" name="formulir" value="{{old('formulir')}}">
